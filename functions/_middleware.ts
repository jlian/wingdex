...
const ROUTE_MAP: Array<{ prefix: string; method?: string; op: string; category: Category }> = [
  ...
  { prefix: '/api/identify-bird', op: 'birdId/identify/invoke', category: 'Application' },
  { prefix: '/api/data/outings/', method: 'DELETE', op: 'data/outings/delete', category: 'Application' },
  { prefix: '/api/data/outings/', op: 'data/outings/write', category: 'Application' },
  { prefix: '/api/data/outings', method: 'POST', op: 'data/outings/write', category: 'Application' },
  { prefix: '/api/data/observations', op: 'data/observations/write', category: 'Application' },
  { prefix: '/api/data/photos', op: 'data/photos/write', category: 'Application' },
  { prefix: '/api/data/dex', method: 'GET', op: 'data/dex/read', category: 'Application' },
  { prefix: '/api/data/dex', op: 'data/dex/write', category: 'Application' },
  { prefix: '/api/data/clear', op: 'data/clear/delete', category: 'Audit' },
  { prefix: '/api/data/all', op: 'data/all/read', category: 'Application' },
