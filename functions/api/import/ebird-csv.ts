...
export const onRequestPost: PagesFunction<Env> = async context => {
  ...
  log?.info('import/ebirdCsv/import', { category: 'Application', resultDescription: `Parsed ${previews.length} sighting rows from ${file.size}-byte CSV`, properties: { fileSize: file.size, rowCount: previews.length } })
