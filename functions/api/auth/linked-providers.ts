...
export const onRequestGet: PagesFunction<Env> = async context => {
  ...
  log?.debug('auth.linkedProviders', { category: 'Auth', resultDescription: `User has ${providers.length} linked auth providers`, properties: { providerCount: providers.length } })
