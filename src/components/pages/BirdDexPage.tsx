          ...
          <div className="space-y-2">
            ...
            <div>
              {sightings.map(({ observation, outing }) => (
                <button
                  key={observation.id}
                  className="flex w-full items-center gap-3 px-2 border-b border-border rounded-lg text-left cursor-pointer hover:bg-muted/30 active:bg-muted transition-colors"
