  ...
  return (
    <LegalPageLayout title="Terms of Use" updated="September 2026">
        ...
        <section className="space-y-1">
          ...
          <p>These Terms, together with the <a href="/privacy.html" className="underline underline-offset-2 hover:text-foreground transition-colors">Privacy Policy</a>, constitute the entire agreement regarding use of the Service.</p>
        </section>
