...
## [1.3.0](https://github.com/jlian/birddex/compare/birddex-v1.2.0...birddex-v1.3.0) (2026-02-16)


### Features

* add AI test fixtures with real LLM responses ([#63](https://github.com/jlian/birddex/issues/63)) ([a251e06](https://github.com/jlian/birddex/commit/a251e0653949f015ab1eca7ab28f136fc1301903))
* add dark mode support ([95b6674](https://github.com/jlian/birddex/commit/95b6674c93192ec2b2b2439b70286e4b02db2e00))
* big CTA card homepage, fix skeleton color, smoother bird detail ([02730a2](https://github.com/jlian/birddex/commit/02730a2f3499b065ac59e51ff7a328a433b4f0e5))
* consistent cards, animations, seed data, delete data ([59906bd](https://github.com/jlian/birddex/commit/59906bd95b81fcbe08b9f40d28cc4819505f58b9))
* E1 homepage layout, rename tab to BirdDex, MapPin outings icon ([ff3996f](https://github.com/jlian/birddex/commit/ff3996f92f52822858fd8e45f54468d80cf848ff))
* **ebird:** export record-format CSV and add conformance tests ([d24c628](https://github.com/jlian/birddex/commit/d24c62842eacc964c379b04ecaf871e32e12fbb5))
* expand AI fixtures to all 27 images, rename for consistency ([c281324](https://github.com/jlian/birddex/commit/c28132409e920c4330de09e894abd8e034d95153))
* extract saved locations from eBird CSV import ([3cd4b05](https://github.com/jlian/birddex/commit/3cd4b0562705fe241b4240f68ab1b53f88b08885))
* minimal typographic homepage header ([0780084](https://github.com/jlian/birddex/commit/07800848f092b42c65fc290278d7c77f0ac6b966))
* outing detail view, saved locations UI, title/favicon, PRD updates ([1750b7a](https://github.com/jlian/birddex/commit/1750b7ad0c94d1f483b8ccfdddcdb33021fbb53e))
* replace homepage top with 3 enriched stat cards ([7a1c6bd](https://github.com/jlian/birddex/commit/7a1c6bdf9ffec30a77e5bef868164ef41ae33b20))
* replace stat cards with compact inline stats on homepage ([3908041](https://github.com/jlian/birddex/commit/3908041be0e7d3f1684adcb9cf843519f3d92ede))
* responsive desktop layout, top nav, homepage redesign, species detail view ([cb0a8b3](https://github.com/jlian/birddex/commit/cb0a8b32e766f05537616a114b1007ada2c51c89))
* **security:** harden user isolation and auth guard ([79cbee7](https://github.com/jlian/birddex/commit/79cbee7ea99b362632cecd5d330637965abb58f5))
* **security:** harden user isolation and auth guard ([5ff69ea](https://github.com/jlian/birddex/commit/5ff69ea1dcf01918867e958bc86cbef669d98710))


### Bug Fixes

* add 'None' option to TZ picker for eBird World region users ([e30b613](https://github.com/jlian/birddex/commit/e30b6130b016ce9158d6d2f4689aa4223d83dd1f))
* add Merlin to WIKI_OVERRIDES to show bird article instead of mythical figure ([98ed5c6](https://github.com/jlian/birddex/commit/98ed5c694657e03763bd571e1155b50b8c82aaf0))
* address remaining PR review comments ([385a65d](https://github.com/jlian/birddex/commit/385a65d650ce0760e5d8c5a86f3a25547fb8487c))
* address second round of review comments ([02f8423](https://github.com/jlian/birddex/commit/02f8423045aaf0f7c066013228d8d856616b721f))
* align react-dom version with react to fix [#527](https://github.com/jlian/birddex/issues/527) mismatch error ([8c2b23b](https://github.com/jlian/birddex/commit/8c2b23b6eb695f7def68956ff3a13e2a3bb0eb13))
* **ci:** gate Spark runtime/KV calls to Spark hosts ([6c97ca0](https://github.com/jlian/birddex/commit/6c97ca0715aec77f7f624aa6b85c7fd26dafbd99))
* clarify TZ help text — it's the submitting device's timezone ([150ca17](https://github.com/jlian/birddex/commit/150ca179d50dcebf10f3b99473c13bcf085a73ad))
* consistent layout, hash routing, visual polish ([57ba8eb](https://github.com/jlian/birddex/commit/57ba8eb412a15c01c2ea8d1a5440de41f4e57176))
* consolidate page transitions to fast fade-in, fix scrollbar shift ([698910d](https://github.com/jlian/birddex/commit/698910d23d3de1debbb261a56415bedde548bde7))
* convert eBird CSV times from profile TZ to observation-local ([#59](https://github.com/jlian/birddex/issues/59)) ([2a9fe08](https://github.com/jlian/birddex/commit/2a9fe08232ed1f8bb243110de87918265968bfd8))
* crossfade skeleton→content on bird detail, elegant borderless hero ([cc9a18d](https://github.com/jlian/birddex/commit/cc9a18d3a86d3cf44d61a35ccec058123bd0a924))
* **data:** reconcile dex aggregates and improve privacy-safe location handling ([ec48951](https://github.com/jlian/birddex/commit/ec48951ed5667394995b47714c881441a3cf04ae))
* dialog scrollbar shift, redesign footer with GitHub logo ([40f3c93](https://github.com/jlian/birddex/commit/40f3c93eb94df35470e85fa1c86ca82c91fbdf5a))
* eBird links, taxonomy grounding, and Wikipedia coverage ([5b1cb31](https://github.com/jlian/birddex/commit/5b1cb31ef1bcb81c1775ddc7ab8a3f4ade7f5817))
* image sizing, hover alignment, highlights grid, homepage outing feedback ([5672f0f](https://github.com/jlian/birddex/commit/5672f0ffb903e6881fc1c5fce631680ebd677aff))
* iOS Mail list style, accent→green, tab hover, homepage consolidation ([6c9e183](https://github.com/jlian/birddex/commit/6c9e183e9eea8de177c25c98a20264d3130f927e))
* iOS share/PWA icons — split manifest purposes, add sizes attribute ([6e886e0](https://github.com/jlian/birddex/commit/6e886e067b73f99b32471c3f80490ffc8f759134))
* keep scrollbar visible during dialog to prevent shift without gutter ([22c56cb](https://github.com/jlian/birddex/commit/22c56cb22d98c1fe49f0613fe2e2e9b6bb36bf7a))
* keep taxonomy aligned with eBird, use wiki override for Chukar ([3efe908](https://github.com/jlian/birddex/commit/3efe908081cc3e011d7e65daba925f428c936dd9))
* **kv:** stop repeated Spark KV fetch loops on rerender ([09ead78](https://github.com/jlian/birddex/commit/09ead78ab9ac132a92dc7dcd038f72db304c505c))
* move border-b to outer row div, add Back text to back buttons ([e4947b5](https://github.com/jlian/birddex/commit/e4947b588a10acb57616ba44df5ed26e16c183fe))
* neutral skeleton colors, smoother bird detail loading, faster fade ([c4cc27f](https://github.com/jlian/birddex/commit/c4cc27f4eac0ac3dc184042f2e92b9c4792621ae))
* override react-remove-scroll-bar margin to prevent dialog shift ([a7e9c7a](https://github.com/jlian/birddex/commit/a7e9c7acf0bea8c8dd738f1ca05019beaf4c1fad))
* prevent first-paint theme flash ([7b3e852](https://github.com/jlian/birddex/commit/7b3e8529e6ddf21517f0851be652885de9a9fd7c))
* regenerate icons with sharp for proper PNG output ([514f898](https://github.com/jlian/birddex/commit/514f898b4894a8dc0431885a5e127d80f6094618))
* regenerate PWA icons from favicon SVG ([c370070](https://github.com/jlian/birddex/commit/c37007018390ecddf80fb62a4353efa40f491f87))
* relax outing distance threshold when times nearly match (Merlin case) ([b2fd1ce](https://github.com/jlian/birddex/commit/b2fd1ceb0a61e442a5fee539ec6063044a921733))
* remove dead suggestBirdCrop, throw on unparseable AI response ([ee4ee19](https://github.com/jlian/birddex/commit/ee4ee1941a45e6f94b9c55fd93e7385860351dd6))
* remove header top gap, add bottom fade edge ([2af976a](https://github.com/jlian/birddex/commit/2af976ab979d402d329180e9d3b898fa4af1e689))
* restore eBird outing grouping when submission IDs are unique ([4c5d057](https://github.com/jlian/birddex/commit/4c5d0579404391d31556004da8098f3e3fa87dc8))
* restore hover/active feedback on lists, fix homepage highlights layout, add cursor-pointer consistency ([ad3de97](https://github.com/jlian/birddex/commit/ad3de9735d54dd3131df059c57a06b9f0e8da6f0))
* restore inset borders with rounded hover, icon-only back buttons, MapPin outings ([da6ccca](https://github.com/jlian/birddex/commit/da6cccae3cbfd2e394ec3888f52f68a06a3b0aea))
* restore iOS Mail inset border, fix double-navigation on BirdRow click ([151746a](https://github.com/jlian/birddex/commit/151746a2f526eefd8a6a0ed0140102f6c3b18050))
* restore scroll position on back navigation ([c94cb31](https://github.com/jlian/birddex/commit/c94cb31816dde4d799c6b384ea2f58841f71d87f))
* scroll to top on navigation, restore position on back ([4894ffa](https://github.com/jlian/birddex/commit/4894ffafcfbeb207d57b47229963b94fceabcd83))
* scrollbar always visible, larger dialog close button, slower fade animation ([2a6cbe6](https://github.com/jlian/birddex/commit/2a6cbe694def0647b6ede03d93db717bbd055d15))
* sort homepage recent species by firstSeenDate to match BirdDex page ([a6dc546](https://github.com/jlian/birddex/commit/a6dc546cb9d935d0b67a2c966a3f63f7d83d67d9))
* surface errors to user — toast on geocode/import failures, detailed messages ([278487a](https://github.com/jlian/birddex/commit/278487aef85f7dbd80858a2dbbc78efea1773dad))
* tab trigger feedback + reimport duplicate warning ([2cd1351](https://github.com/jlian/birddex/commit/2cd135103c3fd48c06feb1a3c44d5dcc553f5d28))
* timezone conversion & taxonomy normalization bugs ([1b8b656](https://github.com/jlian/birddex/commit/1b8b656393083148eb210ae6c15470a33c4bb983))
* UI modernization and bug fixes ([#45](https://github.com/jlian/birddex/issues/45), [#17](https://github.com/jlian/birddex/issues/17), [#59](https://github.com/jlian/birddex/issues/59), [#14](https://github.com/jlian/birddex/issues/14), [#13](https://github.com/jlian/birddex/issues/13)) ([a39b13b](https://github.com/jlian/birddex/commit/a39b13b937d9a86b71fb81d09f2818a95872b455))
* unify top bar, homepage overhaul, normalize lists, species dedup ([d689f33](https://github.com/jlian/birddex/commit/d689f33e40a888080b28ed1d6ffb1a7decaab2ac))
* update BootShell skeleton to match current header and homepage layout ([29b889c](https://github.com/jlian/birddex/commit/29b889c72fe919c0728fa3e14e760072f63889c6))
* update E2E specs for nav redesign ([8e82840](https://github.com/jlian/birddex/commit/8e82840e48d6c6cf43ce6a26312d477ddb3cb9e7))
* update e2e specs for new nav and address review feedback ([f1494f6](https://github.com/jlian/birddex/commit/f1494f610c58ff63b9f4ab32986c12ec02b86613))
* update TZ help text — eBird doesn't document export timezone ([f7619a7](https://github.com/jlian/birddex/commit/f7619a79376bf5219bec03284e0e80ca596778b2))
* update TZ picker help text — region preference doesn't control export ([e2c1a80](https://github.com/jlian/birddex/commit/e2c1a80f8d8b8a27e6136d15d572dd5d78456c92))
* use offset-aware ISO for exifTime and outing timestamps ([8c55ecc](https://github.com/jlian/birddex/commit/8c55ecc9ddb8652e4acea503defeb39d149c277a))
* use valid Tailwind size classes for upload button (size-16/20) ([415c615](https://github.com/jlian/birddex/commit/415c615a001d4f5331e3d6bea632ad75ab5b4341))
* use visible locator for Northern Cardinal in outing detail test ([c8b0238](https://github.com/jlian/birddex/commit/c8b02384e58840c25de880f0e636bc3257d39b6d))
